export const article1 = {
  ...
  content: `
<h2>summary</h2>
<p>The making of CareeVerze.com. A career planning ai web application.
...
<br>
<h2>core problem</h2>
<p>Let's imagine you have just finished studying economics and realized that you want to do something different. You want to do something with product design. This may certainly sound like an extreme case but for a second let's play with the thought that this is really happening...</p>
<br>
...
<br>
<p>To begin with your transition into Product Design, UX Design seems like a great place to start, right? But what is UX Design exactly? And where should I begin my journey with that?</p>
<br>
<p>You google the questions and realize that even though the field of UX Design is barely a decade old, but somehow it has already expanded into this vast place with a myriad of opportunities. So you ask yourself even more questions...</p>
<br>
<p>Should I work on information architecture? Or should I do something with animation design? Or maybe I should become a conversion rate optimization consultant, and fine-tune the heck out of our landing page?</p>
<br>
<p>These are only some of the questions you have to answer to start walking on your journey. And we still haven't even touched on long-term career planning.</p>
<br>
<p>There has to be a better way to plan smartly one of the most important aspects of one's life: career.</p>
<br>
<p>And so we decided to make career planning effective and transparent.</p>
<br>
<p>&#x21B3 <a href="https://docs.google.com/document/d/1J_IHhF7ZPaFdc7pxrkZrEGfZ6KReQm-FJavKL3zsrdk/edit?usp=sharing">mission statement</a></p>
<br>
<h2>competitor analysis</h2>
<p>Initial research has proved that there is indeed a need for a career planning solution. There are currently platforms, individuals, and companies who serve the career counselor role but none of the European players can connect you to your most fitting career options based on current job market conditions.</p>
<br>
<p>&#x21B3 <a href="https://docs.google.com/document/d/1-ttDbFne-rh4DLw8YQ2K93tfEpEZkhF3y_TJmz3QmD4/edit?usp=sharing">competitor analysis</a></p>
<br>
<h2>secondary research</h2>
<p>As a secondary school director in one of our expert interviews had promptly stated: "In most cases, students will go on to do jobs that do not even exist today." This sums up perfectly the current fast-changing market conditions for which teachers, counselors, and institutions are not prepared.</p>
<br>
<p>As much smarter people have said before us, Gen Z - our target user base - is the latest generation to "just barely" enter the workforce. So there is limited research available on this cohort, and of limited quality.</p>
<br>
...
<br>
<p>In addition, our research typically relies on US research, so Gen Z in Europe may be more nuanced than this.</p>
<br>
<p>With that said, we can say that Generation Z is:</p>
<ul>
...
<br>
<p>In order of importance to them in terms of career choice:</p>
<ol>
    <li>Money</li>
    <li>Purpose</li>
...
<br>
<p>And their major challenges are:</p>
<ul>
...
<br>
<p>&#x21B3 <a href="https://docs.google.com/document/d/1LnOwuEtFlfBlD7Y-zOBF8kT7OePxOu-70qbjr3ROlJQ/edit?usp=sharing">secondary research_hu</a></p>
<p>Check out our SECONDARY RESEARCH_HU where we dove deep into the relation between Gen Z and career.</p>
<br>
...
<br>
<p>Some of the emerging questions after the interviews:</p>
<ul>
...
<p>&#x21B3 <a href="https://docs.google.com/document/d/1jftIdNkbyUimFTjZ-JniT93DZnoNDFzTOKONlJVbawM/edit?usp=drive_link">expert interviews</a></p>
<p>Check out our EXPERT INTERVIEWS where we asked senior consultants, teachers, and institutional leaders their thoughts on the relation between younger generations and career.</p>
<br>
<h2>user interviews</h2>
<p>Among the interviewed subjects (university students and high schoolers), there is a typical uncertainty surrounding the choice of "profession". There is a demand for a medium-term commitment (3-5 years) to a career choice, but in the absence of an adequate toolbox, most students plan for the short term (1-2 years). The strategy of choosing a university that broadly covers their interests, but without a concrete idea of where they want to "end up", was typical of the subjects. The choice of career path is perhaps more crystallized towards the end of university.</p>
<br>
<p>Another typical strategy is to study "even further" as a problem-solving tool to answer the career choice. E.g.: after a bachelor's degree, to do a Master's degree or even to start a completely different bachelor's degree. The experience gained can thus be increased within the academy. Students may need support in choosing a career. The question remains whether information on available careers can sufficiently meet this need.</p>
<br>
<p>&#x21B3 <a href="https://docs.google.com/document/d/1KVAxuqTeOMpqTkfMtZNjX9QI1gPPxhw7PTxQmY2fcSg/edit?usp=sharing">user interviews</a></p>
<p>Check out our USER INTERVIEWS where we asked 11 aspiring career starters to tell us their problems, wishes, and thoughts on the matter.</p>
<br>
<h2>pretotyping</h2>
<p>Again we followed the classic double diamond model, but with an agile twist. We research, analyze, create and validate not just on a macro level but on a micro level too. At this point, it became obvious that our problem was real. And so we built a pretotype to test our hypothesis: building a career planning solution could empower GenZ to make well-informed career choices.</p>
<p>&#x21B3 <a href="https://www.figma.com/proto/5eGASZat7L6T7sNebvcwrk/Prototype?page-id=864%3A446&node-id=864%3A1929&viewport=554%2C403%2C0.14&scaling=min-zoom&starting-point-node-id=864%3A2051">pretotype_hu</a></p>
<br>
<p>Check out our PRETOTYPE_HU.</p>
<p>We tested the pretotype with a handful of IT students and Levente - currently doing his master's in computer science - liked the idea (the problem) so much that he joined us on board as our developer.</p>
<br>
<h1>analyze phase</h1>
<br>
<p>
  Since we had a clear goal in mind: build a career planning solution, we knew the users we wanted to serve: Gen Z. And since we had a rich foundation of qualitative research data we jumped headstraight into analyzing. As an end result we hypothesized a possible user journey and finally formed our persona.
</p>
<br>
...
<br>
<p>&#x21B3 <a href="https://www.figma.com/proto/EObLFuDJf7Jepf64KOhYoY/Karrierd%C5%91-Proto?page-id=32630%3A96169&type=design&node-id=32630-99535&viewport=1308%2C2127%2C0.15&t=KPrj3umNo66CHtGN-1&scaling=scale-down&starting-point-node-id=32630%3A99535&mode=design">figma prototype</a></p>
<br>
<p>
