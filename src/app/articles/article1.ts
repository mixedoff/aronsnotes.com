export const article1 = {
  ...
  date: '05.08.2023',
  folder: ['design'],
  subFolder: ['ux', 'market-research'],
  subSubFolder: ['ux-research'],
  project: 'CareeVerz',
  title: 'CareeVerz UX and market research',
  subtitle: 'The making of CareeVerz.com a career planning AI webapp',
  technologies: ['figma'],
  size: null,
  author: null,
  published: null,
